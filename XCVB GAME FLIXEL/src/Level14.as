package{ /** @author David Ryan */
	...
	public class Level14 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level14Indigo, Sources.Map, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(128,96,Sources.ImgBlankGoal);
			
			player.x = 50;
			player.y = 100;
			rainbowGoal.x = 128;
			rainbowGoal.y = 128+32;
			player.Xspeed = 140;
			player.Yspeed = 140;
