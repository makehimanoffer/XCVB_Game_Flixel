package{ /** @author David Ryan */
	...
	public class Level1BAW extends FlxState
	{
		...
		public function Level1BAW():void
		{
		...
		override public function create():void
		{
			...
			PlaySound = true;
			map = new FlxTilemap();
			map.loadMap(new Sources.Level1BAWImg, Sources.MapBAW, 32, 32);
			add(map);
...
emitter.start();
		...
		override public function update():void
		{
			...
			if (player.isTouching(FlxObject.ANY)) {
				...
				//FlxG.switchState(new Level1BAW());
				player.x = 50;
				player.y = 100;
            ...
            API.unlockMedal("Take The Black 1");
