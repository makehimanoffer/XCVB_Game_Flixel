package{ /** @author David Ryan */
	...
	public class Level9 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level9Red, Sources.Map, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(192,96-32,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Rotation Cam"); FlxG.switchState(new Level10());
