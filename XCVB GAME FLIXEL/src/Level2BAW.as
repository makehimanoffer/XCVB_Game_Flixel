package{ /** @author David Ryan */
	...
	public class Level2BAW extends FlxState
	{
		...
		var trail:FlxTrail;
		public function Level2BAW():void
		{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.L2BAW, Sources.MapBAW, 32, 32);
			add(map);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Take The Black 2");	
