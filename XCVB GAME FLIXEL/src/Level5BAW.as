package{ /** @author David Ryan */
	...
	public class Level5BAW extends FlxState
	{
		...
		public function Level5BAW():void
		{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.L5BAW, Sources.MapBAW, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(32,288,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Take The Black 5");
