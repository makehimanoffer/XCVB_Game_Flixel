package{ /** @author David Ryan */
	...
	public class Level18 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level18Rainbow3, Sources.Map, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(64,384,Sources.ImgBlankGoal);
