package{ /** @author David Ryan */
	...
	public class Level8 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level8Rainbow, Sources.Map, 32, 32);
			add(map);
			...
			player.Xspeed = 140;
			player.Yspeed = 140;
			blankGoal = new FlxSprite(480,160,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("WOO FREAKING RAINBOW");	FlxG.switchState(new Level9());
			}
