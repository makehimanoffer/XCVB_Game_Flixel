package{ /** @author David Ryan */
	...
	public class Level19 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level19Rainbow4, Sources.Map, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(96,288,Sources.ImgBlankGoal);
