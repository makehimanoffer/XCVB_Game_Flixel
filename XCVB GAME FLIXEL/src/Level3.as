package{ /** @author David Ryan */
	...
	public class Level3 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level3Yellow, Sources.Map, 32, 32);
			add(map);
			...
			player.x = 64;
			player.y = 128;
			blankGoal = new FlxSprite(496,96,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Yellow Level 1");	FlxG.switchState(new Level4());
			}
