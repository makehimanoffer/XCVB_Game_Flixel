package{ /** @author David Ryan */
	...
	public class Level4 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level4Green, Sources.Map, 32, 32);
			add(map);
			...
			player.Xspeed = 120;
			player.Yspeed = 120;
			blankGoal = new FlxSprite(496,480,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Green Level 1");	FlxG.switchState(new Level5());
			}
