package{ /** @author David Ryan */
	...
	public class Level6 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level6Indigo, Sources.Map, 32, 32);
			add(map);
			...
			player.Xspeed = 140;
			player.Yspeed = 140;
			blankGoal = new FlxSprite(496,64,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Indigo Level 1");	FlxG.switchState(new Level7());
			}
