package{ /** @author David Ryan */
	...
	public class Level20 extends FlxState
	{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.Level20Rainbow5, Sources.Map, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(416,256-32,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			if (FlxG.camera.angle <=90 &&rotate ==true)
			{
				FlxG.camera.angle += 1;
			...
			API.unlockMedal("Beat The Game");
				FlxG.switchState(new MenuColor());
