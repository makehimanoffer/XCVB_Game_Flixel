package{ /** @author David Ryan */
	...
	public class Level3BAW extends FlxState
	{
		...
		var trail:FlxTrail;
		public function Level3BAW():void
		{
		...
		override public function create():void
		{
			...
			map = new FlxTilemap();
			map.loadMap(new Sources.L3BAW, Sources.MapBAW, 32, 32);
			add(map);
			...
			blankGoal = new FlxSprite(128,256+50,Sources.ImgBlankGoal);
...
emitter.start();
		...
		override public function update():void
		{
			...
			API.unlockMedal("Take The Black 3");
